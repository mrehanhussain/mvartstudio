	...
	return (
		<search className="group/search relative">
			...
			{query && (
				<output
					htmlFor="query"
					className="anim-fade group-not-hover/search:group-not-has-[:is(:focus,.results:hover)]/search:hidden border-border-subtle rounded-b-control absolute inset-x-0 top-full z-1 origin-top overflow-hidden border-x border-b starting:-translate-y-1 starting:scale-95"
				>
